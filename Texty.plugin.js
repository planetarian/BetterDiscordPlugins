/**
 * @name Texty
 * @description An obnoxious plugin that translates e[text] into emoji form.
 * @version 0.1.1
 * @author Chami
 * @authorId 165709167095578625
 * @website https://github.com/planetarian/BetterDiscordPlugins
 * @source https://raw.githubusercontent.com/planetarian/BetterDiscordPlugins/master/Texty.plugin.js
 */
/*@cc_on
@if (@_jscript)
...
const config = {
    info: {
        ...
        github_raw: "https://raw.githubusercontent.com/planetarian/BetterDiscordPlugins/master/Texty.plugin.js"
    },
    changelog: [
        {
            title: "0.1.1",
